...
For developers who wish to integrate the WalletConnect functionality into their dApps running on Nordek, we recommend using [this library](http://www.nordek.io/).
